...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 12, 2017 at 08:02 PM
...
(24, 13, 'Computer Source Service Centre', 'Service Provider', 'We give you a better service.', 'images/company_images/Computer.jpg', 'IDB,Dhaka', '017342345', 'testing1@gmail.com', 54, 1),
(25, 14, 'Samsung', 'Cell Phone Company', 'We provide best smart phones.', 'images/company_images/index.jpg', 'Sadar,Barisal', '016886567', 'testing2@gmail.com', 18, 1),
...
(27, 16, 'Suzuki', 'Motor Bike', 'We provide best bike', 'images/company_images/1.jpg', 'Dhaka', '01629892811', 'test4@gmail.com', 2, 1),
...
(4, 24, 13, 'HP 15-BA010AU AMD Quad Core', '#002', 'Very good quality', 'images/product_image/New_Models-500x5003.jpg', '22,500', 12);
...
(18, 12, 4, 13, 1, 'Dolphin Computers Limited', 'Computer', 'Here you will get all Computer things', '01/Dumki,M.K.Ali Hall', '0172391831', '', 1, 0),
...
(27, 4, 12, 3, 1, 'Photography', 'Candid Photograpy', 'We provide good service', 'Dhaka', '01739283928', 'kaziabir36@gmail.com', 1, 21),
...
--
ALTER TABLE `tbl_comments`
  MODIFY `comments_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
--
...
--
ALTER TABLE `tbl_shipping`
  MODIFY `shipping_id` int(7) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
